                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="mb-4 md:mb-0">
                        ...
                        <ul class="list-none">
                            ...
                            <li><a href="/services" class="text-green-500 hover:underline">Services</a></li>
                            <li><a href="/service-areas" class="text-green-500 hover:underline">Service Areas</a></li>
                            <li><a href="/#contact" class="text-green-500 hover:underline">Contact Us</a></li>
                        </ul>
                    </div>
                    <div class="mb-4 md:mb-0">
